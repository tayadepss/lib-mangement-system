package com.lib.bookservice.config;
 ...
 @Bean
   OpenAPI gateWayOpenApi() {   
       return new OpenAPI()
       		...
       		.info(new Info()
       				.title("Swagger Address Service Documentation ")
                       .description("Documentation for all the Rest PAI in Swagger Address Service ")
                       .version("v1.0.0")
                       .contact(new Contact()
