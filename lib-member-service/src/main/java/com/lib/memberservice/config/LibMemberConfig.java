package com.lib.memberservice.config;
 ...
 @Bean
   OpenAPI gateWayOpenApi() {   
       return new OpenAPI()
       		...
       		.info(new Info()
       				.title("Lib Member Service Documentation ")
                       .description("Documentation for all the Rest PAI in Lib Member Service")
                       .version("v1.0.0")
                       .contact(new Contact()
